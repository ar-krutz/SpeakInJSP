				...
				<div class="col">
					<div class="header_content d-flex flex-row align-items-center justify-content-start">
						...
						<div class="header_content_right ml-auto text-right">
							...
							<div class="user"><a href="/Account"><i class="fa fa-user" aria-hidden="true"></i></a></div>
...
<div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
	...
	<nav class="menu_nav">
		<ul class="menu_mm">
			<li class="menu_mm"><a href="/TornaHomePage">Home</a></li>
			<li class="menu_mm"><a href="/VisualizzaCorsiHomePage">Corsi</a></li>
			<li class="menu_mm"><a href="/VisualizzaDocentiHomePage">Docenti</a></li>
