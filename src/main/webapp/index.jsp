...
<html lang="en">
<head>
<title>SpeakIn Language School</title>
<meta charset="utf-8">
...
<div class="super_container">
			...
			<div class="container">
				<div class="row">
					<div class="col text-center">
						<h1 class="home_title">Impara le lingue facilmente</h1>
						<div class="home_button trans_200"><a href="#">ACCEDI AI CORSI</a></div>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="courses">
		...
		<div class="container">
			<div class="row">
				<div class="col">
					<h2 class="section_title text-center">Corsi popolari</h2>
				</div>
			</div>
	...
	<div class="instructors">
		...
		<div class="container">
			<div class="row">
				<div class="col">
					<h2 class="section_title text-center">I migliori docenti</h2>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="register_form_container">
						<div class="register_form_title">Compila il form</div>
						<form action="#" id="register_form" class="register_form">
							<div class="row register_row">
								...
								<div class="col-lg-6 register_col">
									<input type="email" class="form_input" placeholder="Cognome*" required="required">
								</div>
								<div class="col-lg-6 register_col">
									<input type="tel" class="form_input" placeholder="Email*"  required="required">
								</div>
								<div class="col-lg-6 register_col">
									<input type="url" class="form_input" placeholder="Telefono">
								</div>
								<div class="col">
									<button type="submit" class="form_button trans_200">ISCRIVITI</button>
								</div>
							</div>
						</form>
					</div>
				...
				<div class="col-lg-6">
					<div class="register_timer_container">
						<div class="register_timer_title">Iscriviti alla newsletter</div>
						<div class="register_timer_text">
							<p>Riceverai un codice sconto del 10% per Email iscrivendoti entro i termini</p> 
						</div>
	...
	<div class="events">
		<div class="container">
			<div class="row">
				<div class="col">
					<h2 class="section_title text-center">Prossimi Eventi</h2>
				</div>
			</div>
